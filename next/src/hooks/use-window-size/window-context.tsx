...
export const WindowContext = createContext<WindowContextInterface>(
  defaultValues
);
...
export const WindowProvider = ({ children }: WindowProviderInterface) => {
  ...
  const heightStyle =
    windowSize.height != null ? `${windowSize.height}px` : "100vh";
  const widthStyle =
    windowSize.width != null ? `${windowSize.width}px` : "100vw";
